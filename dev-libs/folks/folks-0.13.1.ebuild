...
#PATCHES=(
#	"${FILESDIR}"/0.12.1-conditional-tests.patch # Allow not building lots of test executables when tests are disabled
#	"${FILESDIR}"/0.12.1-no-tracker-tests.patch # TODO: Tracker tests fail; this removed them for now
#)
